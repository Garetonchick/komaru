...
//             //                         SymbolInfo{
//             //                             .type = lang::Type::Function(cnode->GetType(),
//             rets[i]),
...
//     //     return lang::Morphism::Common(raw_morphism, lang::Type::Singleton(),
//     symbol_info.type);
//     // }
...
//         auto wrong_char_err = MakeCookingError(std::format("Wrong character \"{}\"",
//         raw_literal));
